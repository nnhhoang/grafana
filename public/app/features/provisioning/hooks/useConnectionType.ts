...
import { type GitHubBasedConnectionType, type WizardFormData } from '../Wizard/types';
 ...
 * it watches repository.type and returns the GitHub-based connection type ('github' | 'githubEnterprise'),
 * or undefined for non-GitHub repository types. Avoids storing redundant derived state on the form.
 */
export function useConnectionType(): GitHubBasedConnectionType | undefined {
